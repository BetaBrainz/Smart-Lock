...
const char* ssid = "BR Home 2.4G";       //wifi name 
const char* password = "UBrb_241";       //password 
char auth[] = "lMasIQSXgVHRdXVpprFtwp1P5NZeNgWI";          //sent by Blynk 
...
void loop() { 
  ...
  if(digitalRead(IN_BUTTON) == LOW){//DONTTOUCH 
    digitalWrite(LOCK,HIGH); 
    delay(3000); 
